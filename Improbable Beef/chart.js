...
function buildCharts(sampleID) {
  console.log['buildCharts is called with the sample ID: ${sampleID}'];
...
function buildGaugeCharts(sample) {
  console.log('buildGaugeCharts is called with the sample ID: ${sampleID}');
  ...
  d3.json("samples.json").then(function (data) {
    ...
    var otu_wfreq = result.otu_wfreq;
